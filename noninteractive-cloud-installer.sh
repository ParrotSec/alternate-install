...
function core_install() {
	echo -e "deb http://mirrors.mit.edu/parrot parrot main contrib non-free" > /etc/apt/sources.list.d/parrot.list
	...
	parrot-mirror-selector usa #change it if you want another mirror, launch it without parameters to get the full list of available mirrors
	apt-get update
